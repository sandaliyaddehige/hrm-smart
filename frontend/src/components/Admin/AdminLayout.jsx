...
import { FaThLarge, FaUsers, FaMoneyBillWave, FaCalendarCheck, FaUserTie, FaFileAlt, FaCog, FaSignOutAlt, FaBell, FaSearch } from 'react-icons/fa'
import logo from '../../assets/logo.webp'

const navItems = [
  { path: '/dashboard',   label: 'Dashboard',   icon: FaThLarge       },
  { path: '/employees',   label: 'Employees',   icon: FaUsers         },
  { path: '/payrolls',    label: 'Payrolls',    icon: FaMoneyBillWave },
  { path: '/attendance',  label: 'Attendance',  icon: FaCalendarCheck },
  { path: '/recruitment', label: 'Recruitment', icon: FaUserTie       },
  { path: '/reports',     label: 'Report',      icon: FaFileAlt       },
    ...
    <div className="flex h-screen w-full bg-slate-50 overflow-hidden font-sans">
      ...
      <aside className="w-[260px] min-w-[260px] h-screen bg-white border-r border-slate-100 flex flex-col px-5 py-8 shadow-[4px_0_15px_rgba(0,0,0,0.02)]">
        ...
        <div className="flex items-center gap-3 px-2 mb-6">
          ...
          <div>
            <h3 className="font-extrabold text-slate-800 text-[15px] m-0 tracking-tight">Admin View</h3>
